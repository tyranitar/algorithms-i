# Same Dijkstra's implementation from part II of the course,
# but uses homemade heap implementation instead.
    ...
    try:
        for i in range(n - 1): # Going to run exactly n - 1 times since we already have s.
            ...
            while True: # Not sure if loop needed.
                min_edge = h.extract_min() # Will throw IndexError if further exploration is impossible.
                v = min_edge[1]
